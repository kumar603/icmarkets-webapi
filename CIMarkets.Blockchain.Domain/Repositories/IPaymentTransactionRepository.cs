...
namespace CIMarkets.Blockchain.Domain.Repositories
{
    ...
    public interface IPaymentTransactionRepository
    {
        ...
        Task<IEnumerable<PaymentTransaction>> GetByCustomerIdAsync(string customerId, CancellationToken cancellationToken = default);
        ...
        Task<IEnumerable<PaymentTransaction>> GetByStatusAsync(PaymentStatus status, CancellationToken cancellationToken = default);
        ...
        Task<int> GetCountByStatusAsync(PaymentStatus status, CancellationToken cancellationToken = default);
